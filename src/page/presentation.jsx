export default function Presentation () {
    return (
        <div className="text-container">
            ...
            <p> <span className="app-name">Petit Matin</span> offre une expérience ludique et engageante, tout en aidant les enfants à développer des habitudes saines et responsables dès leur plus jeune âge en mettant à leur disposition leur une "todo liste" interactive qui les guide à travers chaque étape de leur routine matinale, du réveil au départ pour l'école. Avec des illustrations colorées et des instructions simples, même les plus jeunes enfants peuvent facilement suivre leur progression.</p>

            <p>En plus de la todo list, <span className="app-name">Petit Matin</span> comprend également des rappels sonores pratiques pour aider les enfants à rester sur la bonne voie. Des notifications amicales qui rappellent à l'enfant les tâches à accomplir, lui permettant ainsi de rester concentré et organisé, même lors des matins les plus mouvementés.</p>
